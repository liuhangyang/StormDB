/*************************************************************************
	> File Name: StormDB_String.cpp
	> Author:yanglongfei 
	> Mail:yanglongfei@xiyoulinux.org 
	> Created Time: 2017年01月14日 星期六 22时43分02秒
 ************************************************************************/
...
String& 
String::StringAdd(const String &str2){
    *this += str2;
    return *this;
}
String&
...
String& 
String::StringSizeClear(size_t pos,size_t len){
...
String&
String::StringChange(const char *s){
    *this = s;
    return *this;
}
String&
String::StringChange(const String &st){
    *this = st;
    return *this;
}
char*
String::StringGetChar(){
    return str;
}
